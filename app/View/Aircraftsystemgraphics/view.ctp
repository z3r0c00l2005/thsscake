...
<div class="actions">
	<ul>
		...
		<li><?php echo $this->AclHtml->link(__('Add Comment'), array('controller' => 'aircraftsystemgraphicscomments', 'action' => 'add', $aircraftsystemgraphic['Aircraftsystemgraphic']['id'])); ?> </li>
		<li><?php echo '<br>'; ?></li>
